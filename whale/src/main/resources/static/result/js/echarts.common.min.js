! function(t, e) {
	...
	function d(t, e, n) {
		if(t && e)
			if(t.forEach && t.forEach === qf) t.forEach(e, n);
	...
	function Bt(t, e, n) {
		...
		if(i !== r)
			if(i > r) t.length = r;
				...
				for(a = i; a < r; a++) t.push(1 === n ? e[a] : Ep.call(e[a]));
	...
	function Ft(t, e, n, i, r, o, a, s, l) {
		var h = t.length;
		if(1 == l)
			for(c = 0; c < h; c++) s[c] = Gt(t[c], e[c], n[c], i[c], r, o, a);
		else
			for(var u = t[0].length, c = 0; c < h; c++)
				for(var d = 0; d < u; d++) s[c][d] = Gt(t[c][d], e[c][d], n[c][d], i[c][d], r, o, a)
	}
			...
			if(o || !x) {
				...
				var O = new ft({
					...
					onframe: function(t, e) {
						...
						if(0 !== i)
							if(I = (e - m[n]) / i, l)
								if(C = v[n], T = v[0 === n ? n : n - 1], A = v[n > h - 2 ? h - 1 : n + 1], D = v[n > h - 3 ? h - 1 : n + 2], d) Ft(T, C, A, D, I, I * I, I * I * I, a(t, r), g);
								else {
									if(f) o = Ft(T, C, A, D, I, I * I, I * I * I, L, 1), o = Wt(L);
									else {
						...
						else if(d) Nt(v[n], v[n + 1], I, a(t, r), g);
						else {
							var o;
							if(f) Nt(v[n], v[n + 1], I, L, 1), o = Wt(L);
							else {
		...
		for(k = 0; k < a.length; k++) {
			for(var p = a[k], g = 0, m = 0, v = 0; v < p.tokens.length; v++) {
				...
				if("string" == typeof b && "%" === b.charAt(b.length - 1)) P.percentWidth = b, h.push(P), b = 0;
					...
					null != D && D < b && (!S || D < T ? (P.text = "", P.textWidth = b = 0) : (P.text = ve(P.text, D - T, _, c.ellipsis, {
						minChar: c.minChar
	...
	function Ee(t, e, n, i, r, o, a, s) {
		...
		var d = Ge(l.textStroke || i.textStroke, p),
			f = He(l.textFill || i.textFill),
	...
	function Mn(t) {
		...
		Ng(t, function(t, n) {
			...
			var i = t.exist,
				...
				o = t.keyInfo;
			if(Bg(r)) {
				if(o.name = null != r.name ? r.name + "" : i ? i.name : Fg, i) o.id = i.id;
	...
	function Wn(t, e, n, i, r, o) {
		var a = i + 3 * (e - n) - t,
			...
			d = l * l - 3 * s * h,
			f = 0;
		if(Vn(u) && Vn(c)) Vn(s) ? o[0] = 0 : (M = -l / s) >= 0 && M <= 1 && (o[f++] = M);
		else {
			var p = c * c - 4 * u * d;
			if(Vn(p)) {
				var g = c / u,
				...
				var _ = (2 * u * s - 3 * a * c) / (2 * Qg(u * u * u)),
					w = Math.acos(_) / 3,
					b = Qg(u),
					S = Math.cos(w),
					M = (-s - 2 * b * S) / (3 * a),
					m = (-s + b * (S + em * Math.sin(w))) / (3 * a),
	...
	function Zn(t, e, n, i, r) {
		var o = 6 * n - 12 * e + 6 * t,
			...
			s = 3 * e - 3 * t,
			l = 0;
		if(Vn(a)) Fn(o) && (c = -s / o) >= 0 && c <= 1 && (r[l++] = c);
		else {
			var h = o * o - 4 * a * s;
			if(Vn(h)) r[0] = -o / (2 * a);
			else if(h > 0) {
	...
	function qn(t, e, n, i, r) {
		var o = t - 2 * e + n,
			...
			s = t - i,
			l = 0;
		if(Vn(o)) Fn(a) && (c = -s / a) >= 0 && c <= 1 && (r[l++] = c);
		else {
			var h = a * a - 4 * o * s;
			if(Vn(h))(c = -a / (2 * o)) >= 0 && c <= 1 && (r[l++] = c);
			else if(h > 0) {
				var u = Qg(h),
					c = (-a + u) / (2 * o),
					d = (-a - u) / (2 * o);
	...
	function xi(t, e, n, i, r, o, a, s, l, h, u) {
		var c = l * (Ym / 180),
			d = jm(c) * (t - n) / 2 + Xm(c) * (e - i) / 2,
			f = -1 * Xm(c) * (t - n) / 2 + jm(c) * (e - i) / 2,
			p = d * d / (a * a) + f * f / (s * s);
		p > 1 && (a *= Um(p), s *= Um(p));
		var g = (r === o ? -1 : 1) * Um((a * a * (s * s) - a * a * (f * f) - s * s * (d * d)) / (a * a * (f * f) + s * s * (d * d))) || 0,
			m = g * a * f / s,
			v = g * -s * d / a,
			y = (t + n) / 2 + jm(c) * m - Xm(c) * v,
			x = (e + i) / 2 + Xm(c) * m + jm(c) * v,
			_ = Km([1, 0], [(d - m) / a, (f - v) / s]),
			w = [(d - m) / a, (f - v) / s],
			b = [(-1 * d - m) / a, (-1 * f - v) / s],
			S = Km(w, b);
	...
	function Vi(t) {
		if(!t.__isHover) {
			if(Bi(t), t.useHoverLayer) t.__zr && t.__zr.addHover(t, t.__hoverStl);
			else {
				var e = t.style,
	...
	function Jr(t, e, n, i, r) {
		...
		if(e === Jv) "auto" === i || null == i ? eo(function(t) {
			...
			r[e] = null != t ? t : ""
		}, n, t)), o = r ? r.length : n === oy ? t.length : t[0] ? t[0].length : null;
		else if(e === ty) r || (r = no(t), s = !0);
		else if(e === ey) r || (r = [], s = !0, d(t, function(t, e) {
			r.push(e)
		}));
		else if(e === Qv) {
			var l = wn(t[0]);
	...
	function ho(t) {
		t = t, this.option = {}, this.option[sy] = 1, this._componentsMap = R({
			series: []
		}), this._seriesIndices, this._seriesIndicesMap, lo(t, this._theme.option), i(t, Yv, !1), this.mergeOption(t)
	}
	...
	function Ao(t) {
		if(vy(t)) {
			...
			if("graph" === t.type) {
				...
				if(o && !S(o))
					for(s = 0; s < o.length; s++) Co(o[s]);
				d(t.categories, function(t) {
					Io(t)
				})
			}
			if(r && !S(r))
				for(s = 0; s < r.length; s++) Co(r[s]);
			if((e = t.markPoint) && e.data)
				for(var a = e.data, s = 0; s < a.length; s++) Co(a[s]);
			if((n = t.markLine) && n.data)
				for(var l = n.data, s = 0; s < l.length; s++) y(l[s]) ? (Co(l[s][0]), Co(l[s][1])) : Co(l[s]);
	...
	function ra(t) {
		var e = t.model,
			...
			i = t.api,
			r = t.payload,
			o = e.pipelineContext.incrementalRender,
			a = t.view,
	...
	function ca(t, e, n, i, r) {
		...
		var a = n.seriesTaskMap || (n.seriesTaskMap = R()),
			s = e.seriesType,
			l = e.getTargetSeries;
	...
	function da(t, e, n, i, r) {
		function o(e) {
			...
			i.context = {
				...
				overallProgress: u,
				isOverallFilter: c
			}, i.agent = a, i.__block = u, wa(t, e, i)
		}
		var a = n.overallTask = n.overallTask || Wo({
			reset: fa
		});
		a.context = {
			ecModel: i,
		...
		var s = a.agentStubMap = a.agentStubMap || R(),
			l = e.seriesType,
			h = e.getTargetSeries,
			u = !0,
			c = e.isOverallFilter;
	...
	function _s(t, e) {
		var n = t.dimensions,
			i = new Fx(f(n, t.getDimensionInfo, t), t.hostModel);
		gs(i, t);
	...
	function Is(t, e) {
		...
		var h = new Fx(l, e),
			u = null != a && Cs(t) ? function(t, e, n, i) {
	...
	function Ns(t, e, n, i) {
		...
		if(!t) return r;
		e[0] < n[0] && r.push(e[0]);
		for(var o = n[0]; o <= n[1] && (r.push(o), (o = jx(o + t, i)) !== r[r.length - 1]);)
	...
	function Zs(t, e, n) {
		var i = n.ecModel,
			r = n.axis.getExtent(),
			o = r[1] - r[0],
			a = Fs(g(i.getSeriesByType("bar"), function(t) {
	...
	function el(t) {
		...
		for(var n = t.features, i = 0; i < n.length; i++)
			for(var r = n[i].geometry, o = r.coordinates, a = r.encodeOffsets, s = 0; s < o.length; s++) {
				var l = o[s];
				if("Polygon" === r.type) o[s] = nl(l, a[s], e);
	...
	function ml(t, e, n, i, r, o, a, s, l, h, u) {
		for(var c = 0, d = n, f = 0; f < i; f++) {
			...
			if(d === n) t[o > 0 ? "moveTo" : "lineTo"](p[0], p[1]), B_(F_, p);
			else if(l > 0) {
				var g = d + o,
					m = e[g];
				if(u)
					for(; m && gl(e[g]);) m = e[g += o];
				var v = .5,
					y = e[c];
				if(!(m = e[g]) || gl(m)) B_(G_, p);
				else {
					gl(m) && !u && (m = p), W(V_, m, y);
					var x, _;
					if("x" === h || "y" === h) {
	...
	function Sl(t, e, n) {
		...
		return e && (d.shape[o ? "width" : "height"] = 0, ar(d, {
			shape: {
				width: l,
				height: h
			}
	...
	function Ml(t, e, n) {
		...
		return e && (s.shape.endAngle = -o[0] * a, ar(s, {
			shape: {
				endAngle: -o[1] * a
			}
		}, n)), s
	...
	function jl(t, e, n) {
		...
		if(e.get("axisTick.show") && !i.scale.isBlank()) {
			for(var r = e.getModel("axisTick"), o = r.getModel("lineStyle"), s = r.get("length"), l = dw(r, n.labelInterval), h = i.getTicksCoords(r.get("alignWithLabel")), u = i.scale.getTicks(), c = e.get("axisLabel.showMinLabel"), d = e.get("axisLabel.showMaxLabel"), f = [], p = [], g = t._transform, m = [], v = h.length, y = 0; y < v; y++)
				if(!cw(i, y, l, v, c, d)) {
					var x = h[y];
	...
	function Yl(t, e, n) {
		...
		if(T(n.axisLabelShow, e.get("axisLabel.show")) && !i.scale.isBlank()) {
			var r = e.getModel("axisLabel"),
				...
				l = (T(n.labelRotate, r.get("rotate")) || 0) * sw / 180,
				h = uw(n.rotation, l, n.labelDirection),
				u = e.getCategories(),
				c = [],
				f = Hl(e),
		...
		fw(n.getCoordinateSystems(), function(n) {
			function s(i, s, l) {
				...
				if(d && ("auto" !== d || i || rh(c))) {
					...
					var f = (c = i ? Kl(l, u, r, e, i, s) : c).get("snap"),
						p = oh(l.model),
	...
	function wh(t, e, n, i) {
		var r = n.type,
			o = new(0, bv[r.charAt(0).toUpperCase() + r.slice(1)])(n);
	...
	function Th(t, e, n) {
		var r = o({}, n),
			a = t[e],
			s = n.$action || "merge";
		"merge" === s ? a ? (i(a, r, !0), Hr(a, r, {
			ignoreSize: !0
		}), Zr(n, a)) : t[e] = r : "replace" === s ? t[e] = r : "remove" === s && a && (t[e] = null)
	}
	...
	function zh(t, e, n) {
		var i = n.getZr(),
			r = Fw(i).axisPointerLastHighlights || {},
			o = Fw(i).axisPointerLastHighlights = {};
		Bw(t, function(t, e) {
	...
	function cu(t) {
		for(var e = t.pop(); t.length;) {
			var n = t.pop();
			n && (fr.isInstance(n) && (n = n.get("tooltip", !0)), "string" == typeof n && (n = {
				formatter: n
			}), e = new fr(n, e, e.ecModel))
		}
		return e
	}
	...
	function ku(t, e) {
		...
		if(e && !Cu(e) && !y(e.coord) && r) {
			...
			if((e = n(e)).type && vb[e.type] && a.baseAxis && a.valueAxis) {
				var s = gb(o, a.baseAxis.dim),
					l = gb(o, a.valueAxis.dim);
	...
	function Ru(t, e, n) {
		...
		t.each(function(r) {
			var o, a = t.getItemModel(r),
				s = xr(a.get("x"), n.getWidth()),
				l = xr(a.get("y"), n.getHeight());
			if(isNaN(s) || isNaN(l)) {
	...
	function Cd(t, e, n, i, r, o, a, s) {
		...
		cS(r.split(""), function(t) {
			var e = _S[t];
			h[e[0]][e[1]] += u[e[0]]
		}), l.range = e(Md(h[0][0], h[1][0], h[0][1], h[1][1])), cd(n, i), md(n, {
			isEnd: !1
		})
	}
	...
	function Pd(t) {
		var e = fS(t[0][0], t[1][0]),
			n = fS(t[0][1], t[1][1]);
		return {
			x: e,
			y: n,
			width: pS(t[0][0], t[1][0]) - e,
			height: pS(t[0][1], t[1][1]) - n
		}
	}
	...
	function Ed(t, e, i, r) {
		...
		if(t._track.push(i.slice()), vd(t) || a) {
			...
			if(a) {
				...
				a.__brushOption.range = u.getCreatingRange(kd(t, a, t._track)), r && (ld(t, a), u.updateCommon(t, a)), hd(t, a), o = {
					isEnd: r
				}
			}
	...
	var mp = "undefined" == typeof Float32Array ? Array : Float32Array,
		...
		applyTransform: function() {
			...
			return function(r) {
				if(r) {
					...
					var o = Up(t[0], e[0], n[0], i[0]),
						a = Up(t[1], e[1], n[1], i[1]);
	...
	xg.prototype = {
		...
		insertLayer: function(t, e) {
			var n = this._layers,
				...
				a = -1,
				s = this._domRoot;
			if(n[t]) Fp("ZLevel " + t + " has been used already");
			else if(qe(e)) {
				if(r > 0 && t > i[0]) {
	...
	var Lg = !Zf.canvasSupported,
		...
		Eg = function(t, e, n) {
			...
			this.handler = new gp(r, a, s, a.root), this.animation = new Sg({
				stage: {
	...
	var Rg = (Object.freeze || Object)({
		...
		Hg = 0,
		Wg = ".",
		Zg = "___EC__COMPONENT__CONTAINER___",
		Ug = 0,
		Xg = function(t) {
		...
		Im = Math.sqrt,
		Tm = Math.abs,
		Cm = "undefined" != typeof Float32Array,
		Am = function(t) {
	...
	var Dm = 2 * Math.PI,
		...
		zm = [-1, -1, -1],
		Em = [-1, -1],
		Rm = ig.prototype.getCanvasPattern,
		Nm = Math.abs,
		Bm = new Am(!0);
	yi.prototype = {
		constructor: yi,
	...
	mv.prototype = {
		constructor: mv
	}, h(mv, pv), Ci.prototype.incremental = !0, Ci.prototype.clearDisplaybles = function() {
	...
	var my = d,
		vy = w,
		yy = ["areaStyle", "lineStyle", "nodeStyle", "linkStyle", "chordStyle", "label", "labelLine"],
		xy = function(t, e) {
	...
	Dy.perform = function(t) {
		...
		if(this._dueEnd = e ? e._outputDueEnd : this._count ? this._count(this.context) : 1 / 0, this._progress) {
			var a = this._dueIndex,
				s = Math.min(null != o ? this._dueIndex + o : 1 / 0, this._dueEnd);
			!n && a < s && this._progress({
				start: a,
				end: s
		...
		Py = Xv.extend({
			...
			init: function(t, e, n, i) {
				this.seriesIndex = this.componentIndex, this.dataTask = Wo({
					...
					model: this
				}, this.mergeDefaultAndTheme(t, n), Qr(this);
	...
	var Oy = Ly.prototype;
	Oy.updateView = Oy.updateLayout = Oy.updateVisual = function(t, e, n, i) {}, zn(Ly), Bn(Ly, {
		registerWhenExtend: !0
	});
	var zy = function() {
			var t = Cn();
	...
	Ny.updateView = Ny.updateLayout = Ny.updateVisual = function(t, e, n, i) {
		...
		registerWhenExtend: !0
	}), ta.markUpdateMethod = function(t, e) {
		Ey(t).updateMethod = e
	};
	var By = "\0__throttleOriginMethod",
		Vy = "\0__throttleRate",
		Fy = "\0__throttleType",
		Gy = {
			createOnAllSeries: !0,
	...
	Uy.getPerformArgs = function(t, e) {
		if(t.__pipeline) {
			var n = this._pipelineMap.get(t.__pipeline.id),
				i = n.context;
			return {
				step: !e && n.progressiveEnabled && (!i || i.incrementalRender) && t.__idxInPipeline > n.bockIndex ? n.step : null
			}
		}
	...
	var $y = ["#37A2DA", "#32C5E9", "#67E0E3", "#9FE6B8", "#FFDB5C", "#ff9f7f", "#fb7293", "#E062AE", "#E690D1", "#e7bcf3", "#9d96f5", "#8378EA", "#96BFFF"],
		Ky = {
			...
			colorLayer: [
				...
				["#37A2DA", "#32C5E9", "#9FE6B8", "#FFDB5C", "#ff9f7f", "#fb7293", "#e7bcf3", "#8378EA", "#96BFFF"], $y
			]
		},
	...
	fx._onframe = function() {
		...
		if(ix(e) && (n = e.lazyUpdate, i = e.silent, e = e.notMerge), this[ux] = !0, !this._model || e) {
			var r = new vo(this._api),
				o = this._theme,
				a = this._model = new ly(null, null, o, r);
			a.scheduler = this._scheduler, a.init(null, null, o, r)
		}
		this._model.setOption(t, xx), n ? (this[cx] = {
			silent: i
		}, this[ux] = !1) : (Aa(this), px.update.call(this), this._zr.flush(), this[cx] = !1, this[ux] = !1, Oa.call(this, i), za.call(this, i))
	...
	var px = {
		...
		update: function(t) {
			...
			if(e) {
				...
				var a = e.get("backgroundColor") || "transparent",
					s = i.painter;
				if(s.isSingleCanvas && s.isSingleCanvas()) i.configLayer(0, {
					clearColor: a
				});
				else {
					if(!Zf.canvasSupported) {
					...
					a.colorStops || a.image ? (i.configLayer(0, {
						clearColor: a
					}), this.__hasGradientOrPatternBg = !0, this._dom.style.background = "transparent") : (this.__hasGradientOrPatternBg && i.configLayer(0, {
						clearColor: null
					}), this.__hasGradientOrPatternBg = !1, this._dom.style.background = a)
				}
				Ga(e, n)
			}
		},
		...
		updateView: function(t) {
			var e = this._model;
			e && (ta.markUpdateMethod(t, "updateView"), Na(e), this._scheduler.performVisualTasks(bx, e, t, {
				setDirty: !0
			}), Ba(this, this._model, this._api, t), Ga(e, this._api))
		},
	...
	fx.resize = function(t) {
		...
		ix(e) || (e = {
			silent: !!e
		}), mx[t.type] && this._model && (this[ux] ? this._pendingActions.push(t) : (La.call(this, t, e.silent), e.flush ? this._zr.flush(!0) : !1 !== e.flush && Zf.browser.weChat && this._throttledZrFlush(), Oa.call(this, e.silent), za.call(this, e.silent)))
	...
	var Ox = R(["tooltip", "label", "itemName", "itemId", "seriesName"]),
		zx = w,
		Ex = "undefined",
		Rx = typeof window === Ex ? global : window,
		Nx = "e\0\0",
		Bx = {
	...
	Gx.type = "list", Gx.hasItemOption = !0, Gx.getDimension = function(t) {
		...
		if(this._count) {
			...
			if(r) {
				...
				if(!this._indices && !e) {
					var d = 0;
					if(1 === r) {
						for(var f = this._storage[n[0]], p = 0; p < this._chunkCount; p++)
							for(var g = f[p], m = Math.min(this._count - p * this._chunkSize, this._chunkSize), v = 0; v < m; v++)(b = g[v]) >= h && b <= u && (a[s++] = d), d++;
						c = !0
					} else if(2 === r) {
						for(var f = this._storage[l], y = this._storage[n[1]], x = t[n[1]][0], _ = t[n[1]][1], p = 0; p < this._chunkCount; p++)
		...
		for(var r = _s(this, [t]), o = r._storage, a = [], s = Math.floor(1 / e), l = o[t], h = this.count(), u = this._chunkSize, c = new(fs(this))(h), d = 0, f = 0; f < h; f += s) {
			...
			var y = n(a),
				x = this.getRawIndex(Math.min(f + i(a, y) || 0, h - 1)),
				_ = x % u;
	...
	A_._createSymbol = function(t, e, n, i) {
		...
		r.attr({
			...
			culling: !0,
			scale: al(i)
		}), r.drift = ll, this._symbolType = t, this.add(r)
		...
		if(a ? this._createSymbol(i, t, e, o) : ((s = this.childAt(0)).silent = !1, or(s, {
				scale: al(o)
			...
			}), s.scale = [0, 0], l && (s.style.opacity = 0), ar(s, h, r, e)
		}
		this._seriesModel = r
	};
	var D_ = ["itemStyle"],
		k_ = ["emphasis", "itemStyle"],
		P_ = ["label"],
		L_ = ["emphasis", "label"];
	...
	O_.updateData = function(t, e) {
		...
		r || n.removeAll(), t.diff(r).add(function(i) {
			...
			var h = r.getItemGraphicEl(l),
				u = t.getItemLayout(s);
			ul(t, u, s, e) ? (h ? (h.updateData(t, s, a), or(h, {
				position: u
		...
		W_ = yi.extend({
			...
			buildPath: function(t, e) {
				var n = e.points,
					...
					o = n.length,
					a = e.smoothMonotone,
					s = vl(n, e.smoothConstraint),
					l = vl(i, e.smoothConstraint);
				if(e.connectNulls) {
					for(; o > 0 && gl(n[o - 1]); o--);
					for(; r < o && gl(n[r]); r++);
				}
	...
	ta.extend({
		...
		render: function(t, e, n) {
			...
			f && c.type === i.type && b === this._step ? (v && !p ? p = this._newPolygon(h, y, i, m) : p && !v && (g.remove(p), p = this._polygon = null), g.setClipPath(Il(i, !1, t)), x && d.updateData(o, _), o.eachItemGraphicEl(function(t) {
				t.stopAnimation(!0)
			}), yl(this._stackedOnPoints, y) && yl(this._points, h) || (m ? this._updateAnimation(o, y, i, n, b) : (b && (h = Tl(h, i, b), y = Tl(y, i, b)), f.setShape({
				points: h
			}), p && p.setShape({
				points: h,
				stackedOnPoints: y
		...
		_updateAnimation: function(t, e, n, i, r) {
			var o = this._polyline,
				a = this._polygon,
				s = t.hostModel,
				l = z_(this._data, t, this._stackedOnPoints, e, this._coordSys, n),
				h = l.current,
				u = l.stackedOnCurrent,
				c = l.next,
				d = l.stackedOnNext;
			r && (h = Tl(l.current, n, r), u = Tl(l.stackedOnCurrent, n, r), c = Tl(l.next, n, r), d = Tl(l.stackedOnNext, n, r)), o.shape.__points = l.current, o.shape.points = h, or(o, {
				shape: {
					points: c
				}
			}, s), a && (a.setShape({
	...
	K_.categoryAxis = i({
		...
		min: "dataMin",
		max: "dataMax"
	}, K_.valueAxis), K_.logAxis = a({
		scale: !0,
		logBase: 10
	}, K_.valueAxis);
	var Q_ = ["value", "category", "time", "log"],
		J_ = function(t, e, n, o) {
			d(Q_, function(a) {
				e.extend({
					type: t + "Axis." + a,
		...
		function i(n) {
			return function(i, s) {
				if(Pl(i, t, e)) {
					...
					var h = new q_(n, Xs(i), [0, 0], i.get("type"), l),
						u = "category" === h.type;
	...
	var vw = lw.ifIgnoreOnTick,
		yw = lw.getInterval,
		xw = ["axisLine", "axisTickLabel", "axisName"],
		_w = ["splitArea", "splitLine"],
		ww = gw.extend({
			type: "cartesianAxis",
		...
		_render: function(t, e, n) {
			...
			o.diff(a).add(function(e) {
				...
				if(o.hasValue(e)) {
					...
					l ? or(l, {
						shape: c
					}, h, e) : l = Iw[s.type](o, e, u, c, i, h, !0), o.setItemGraphicEl(e, l), r.add(l), fh(l, o, e, u, c, t, i, "polar" === s.type)
				} else r.remove(l)
			}).remove(function(t) {
			...
			cartesian2d: function(t, e, n, i, r, a, s) {
				...
				if(a) {
					var h = l.shape,
						u = r ? "height" : "width",
						c = {};
					h[u] = 0, c[u] = i[u], bv[s ? "updateProps" : "initProps"](l, {
						shape: c
					}, a, e)
				}
				return l
			...
			polar: function(t, e, n, i, r, a, s) {
				...
				if(a) {
					var h = l.shape,
						u = r ? "r" : "endAngle",
						c = {};
					h[u] = r ? 0 : i.startAngle, c[u] = i[u], bv[s ? "updateProps" : "initProps"](l, {
						shape: c
					}, a, e)
				}
				return l
	...
	var Cw = function(t, e, n) {
		...
		Aw = {
			updateSelectedMap: function(t) {
				if(y(t)) this._targetList = t.slice();
					...
					for(var e = t, n = e.mapDimension("value"), t = this._targetList = [], i = 0, r = e.count(); i < r; i++) t.push({
						name: e.getName(i),
						value: e.get(n, i),
		...
		Dw = os({
			...
			getDataParams: function(t) {
				var e = this.getData(),
					n = Dw.superCall(this, "getDataParams", t),
					i = [];
	...
	kw.updateData = function(t, e, n) {
		...
		var s = this.childAt(0),
			...
			u = t.getItemLayout(e),
			c = o({}, u);
		c.label = null, n ? (s.setShape(c), "scale" === l.getShallow("animationType") ? (s.shape.r = u.r0, ar(s, {
			shape: {
				r: u.r
			}
		}, l, e)) : (s.shape.endAngle = u.startAngle, or(s, {
			shape: {
				endAngle: u.endAngle
			}
		}, l, e))) : or(s, {
	...
	Ew.isPersistent = function() {
		...
		this.group.removeAll(), this._clearIncremental(), t.count() > 2e6 ? (this._incremental || (this._incremental = new Ci({
			silent: !0
	...
	var jw = Uh.extend({
			makeElOption: function(t, e, n, i, r) {
				var o = n.axis,
					a = o.grid,
					s = i.get("type"),
					l = ou(a, o).getOtherAxis(o).getGlobalExtent(),
			...
			updateHandleTransform: function(t, e, n, i) {
				var r = n.axis,
					...
					s = ou(o, r).getOtherAxis(r).getGlobalExtent(),
					l = "x" === r.dim ? 0 : 1,
					h = t.position;
	...
	rs({
		...
		_showComponentItemTooltip: function(t, e, n) {
			...
			var o = new fr(i, this._tooltipModel, this._ecModel),
				a = o.get("content"),
				s = Math.random();
		...
		_showTooltipContent: function(t, e, n, i, r, o, a, s) {
			if(this._ticket = "", t.get("showContent") && t.get("show")) {
				...
				a = a || t.get("position");
				var u = e;
				if(h && "string" == typeof h) u = Er(h, n, !0);
	...
	var sb = nb.extend({
		...
		cb = ab.extend({
			...
			renderInner: function(t, e, n, i) {
				function r(t, n) {
					var r = t + "DataIndex",
						l = dr(e.get("pageIcons", !0)[e.getOrient().name][n], {
			...
			layoutInner: function(t, e, n) {
				...
				if((v = {
					...
					y[s] = Math.max(n[s] - c[s] - m, 0), y[l] = v[l], r.setClipPath(new lv({
						shape: y
					})), r.__rectSize = y[s]
	...
	var xb = hv.prototype,
		...
		wb = Ai({
			...
			tangentAt: function(t) {
				var e = this.shape,
					n = Bu(e) ? [e.x2 - e.x1, e.y2 - e.y1] : _b.tangentAt.call(this, t);
				return j(n, n)
			}
		}),
		bb = ["fromSymbol", "toSymbol"],
		Sb = Wu.prototype;
	Sb.beforeUpdate = function() {
		...
		var i = t.hostModel,
			r = Gu(t.getItemLayout(e));
		r.shape.percent = 0, ar(r, {
			shape: {
				percent: 1
			}
		}, i, e), this.add(r);
	...
	var Ab = ["cartesian2d", "polar", "singleAxis"],
		Db = function(t, e) {
			var n = f(t = t.slice(), Br),
				i = f(e = (e || []).slice(), Br);
			return function(r, o) {
				d(t, function(t, a) {
					for(var s = {
		...
		reset: function(t) {
			if(t === this._dataZoomModel) {
				...
				this._dataExtent = lc(this, this._dimName, e), this.hasSeriesStacked = !1, kb(e, function(t) {
					var e = t.getData(),
						n = e.mapDimension(this._dimName);
	...
	var Ob = d,
		...
		Eb = is({
			...
			doInit: function(t) {
				var e = this.option;
				Zf.canvasSupported || (e.realtime = !1), this._setDefaultThrottle(t), fc(this, t), Ob([
					["start", "startValue"],
					["end", "endValue"]
				], function(t, n) {
		...
		Wb = "horizontal",
		Zb = 5,
		Ub = ["line", "bar", "candlestick", "scatter"],
		Xb = Rb.extend({
			type: "dataZoom.slider",
			init: function(t, e) {
			...
			_updateDataInfo: function(t) {
				function e(t) {
					var e = sr(i.handles[t].parent, this.group),
						n = hr(0 === t ? "right" : "left", e),
						s = this._handleWidth / 2 + Zb,
						l = lr([c[t] + (0 === t ? -s : s), this._size[1] / 2], e);
					r[t].setStyle({
						x: l[0],
						y: l[1],
	...
	Uc.defaultOption = {
		...
		if(r.href = a, "function" != typeof MouseEvent || Zf.browser.ie || Zf.browser.edge)
	...
	var aS = Hy.toolbox.dataView,
		sS = new Array(60).join("-"),
		lS = "\t",
		hS = new RegExp("[" + lS + "]+", "g");
	nd.defaultOption = {
		show: !0,
	...
	var MS = {
			mousedown: function(t) {
				if(this._dragging) Nd.call(this, t);
		...
		AS = l,
		DS = v,
		kS = ["dataToPoint", "pointToData"],
		PS = ["grid", "xAxis", "yAxis", "geo", "graph", "polar", "radiusAxis", "angleAxis", "bmap"],
		LS = Zd.prototype;
	LS.setOutputRanges = function(t, e) {
		this.matchOutputRanges(t, e, function(t, e, n) {
			if((t.coordRanges || (t.coordRanges = [])).push(e), !t.coordRange) {
				...
				t.__rangeOffset = {
					offset: NS[t.brushType](i.values, t.range, [1, 1]),
					xyMinMax: i.xyMinMax
				}
			}
		})
		...
		CS(t, function(t) {
			...
			if(t.range = t.range || [], n && !0 !== n) {
				t.panelId = n.panelId;
				var i = RS[t.brushType](0, n.coordSys, t.coordRange),
					r = t.__rangeOffset;
		...
		for(var n = this._targetInfoList, i = Xd(e, t), r = 0; r < n.length; r++) {
			...
			if(a) {
				...
				for(r = 0; r < zS.length; r++)
					if(zS[r](i, o)) return o
		}
		return !0
	};
	var OS = {
		...
		RS = {
			...
			lineY: DS(jd, 1),
			rect: function(t, e, n) {
				var i = e[kS[t]]([n[0][0], n[1][0]]),
					r = e[kS[t]]([n[0][1], n[1][1]]),
	...
	var FS = Hy.toolbox.dataZoom,
		GS = d,
		HS = "\0_ec_\0toolbox-dataZoom_";
	nf.defaultOption = {
		show: !0,
		icon: {
	...
	WS._onBrush = function(t, e) {
		...
		if(e.isEnd && t.length) {
			var r = {},
				o = this.ecModel;
			this._brushController.updateCovers([]), new Zd(rf(this.model.option), o, {
				include: ["grid"]
	...
	var XS, jS = "urn:schemas-microsoft-com:vml",
		YS = "undefined" == typeof window ? null : window,
		qS = !1,
		$S = YS && YS.document;
	...
	if(!Zf.canvasSupported) {
		...
		je.prototype.brushVML = function(t) {
			...
			if(r) {
				...
				if(this.transform && (x = this.transform, b = JS(x[0] * x[0] + x[1] * x[1]), S = JS(x[2] * x[2] + x[3] * x[3]), w = x[1] || x[2]), w) {
					...
					var A = iM(M[0], I[0], T[0], C[0]),
						D = iM(M[1], I[1], T[1], C[1]),
						k = [];
				...
				var O = P.style;
				if(v) {
					if(e && n) O.width = QS(b * e * c / f) + "px", O.height = QS(S * n * d / p) + "px";
					else {
						var z = new Image,
							E = this;
						z.onload = function() {
		...
		! function(t, e) {
			...
			return wM.innerHTML = "", wM.appendChild(n.createTextNode(t)), {
		...
		for(var TM = new Xt, CM = [mg, Xe, je, yi, Qm], AM = 0; AM < CM.length; AM++) {
			...
			DM.drawRectText = function(t, e, n, i) {
				...
				if(null != o && (o += ""), o) {
					...
					if(v && !i && (TM.copy(e), TM.applyTransform(v), e = TM), i) c = e.x, d = e.y;
					else {
						var y = r.textPosition,
							x = r.textDistance;
						if(y instanceof Array) c = e.x + dM(y[0], e.width), d = e.y + dM(y[1], e.height), f = f || "left";
						else {
							var _ = me(y, e, x);
	...
	var kM = "http://www.w3.org/2000/svg",
		PM = Am.CMD,
	...
	var WM = {},
		...
		UM = function(t, e, n) {
			...
			if(null != r) {
				r += "";
				var o = t.__textSvgEl;
				if(o || (o = ff("text"), t.__textSvgEl = o), wf(o, i, !0), t instanceof Qm || t.style.transformText) yf(o, t.transform);
				else if(t.transform) ZM.copy(e), ZM.applyTransform(t.transform), e = ZM;
				else {
				...
				var d = i.font || [i.fontStyle || "", i.fontWeight || "", i.fontSize || "", i.fontFamily || ""].join(" ") || cg,
					f = Sf(i.textVerticalAlign),
					p = (n = ce(r, d, c, f)).lineHeight;
